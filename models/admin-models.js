...
exports.recreateTables = function(){
    ...
    client.query('create table audit (id serial, siteid integer not null, opname text not null, attachment text not null,creation timestamp DEFAULT current_timestamp)');
}
