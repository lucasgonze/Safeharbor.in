...
{
    var text = '<pre>' + err.toString() + "\n\n" + (err.stack || 'no stack available') + '</pre>';
    res.setHeader('Content-Type', 'text/html');    
    res.end(text);
}

/* Could there be a better example of how willfully obscure Victor's style is? Yeah, I'm sure there 
   could be and is and I'll spend a day scratching my head over how it's supposed to work. Fuck this 
   shit. Do not use this turd.
*/
