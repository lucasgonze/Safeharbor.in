...
onShow:function(){},onBeforeHide:function(){},onHide:function(){},onStep:function(){}};var c=$.extend({},T,M),P={position:c.position,live:c.live,offset:c.offset,wait:c.wait,expose:c.expose,overlayOpacity:c.overlayOpacity,delayIn:c.delayIn,delayOut:c.delayOut,animationIn:c.animationIn,animationOut:c.animationOut,onBeforeShow:c.onBeforeShow,onShow:c.onShow,onBeforeHide:c.onBeforeHide,onHide:c.onHide,onStep:c.onStep,element:x,goTo:null},h={start:function(b){C(b)},restart:function(b){O();
